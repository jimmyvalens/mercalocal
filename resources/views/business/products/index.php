...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <h1 class="text-3xl font-bold text-secondary flex items-center gap-3">
                <i class="fa-solid fa-box text-primary"></i> Mis Productos
            </h1>
        </div>
        <a href="<?= BASE_URL ?>/business/dashboard/products/create"
    ...
    <?php if (empty($products)): ?>
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
            ...
            <h3 class="text-xl font-medium text-gray-700 mb-1">Sin productos todavía</h3>
            <p class="text-gray-500 text-sm mb-6">Añade tu primer producto para que los clientes puedan comprarlo.</p>
            <a href="<?= BASE_URL ?>/business/dashboard/products/create" class="btn-primary px-6 py-2.5">
                <i class="fa-solid fa-plus mr-2"></i> Crear primer producto
            </a>
        </div>
    <?php else: ?>
            ...
            <?php foreach ($products as $p): ?>
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col hover:shadow-md transition-all group">
                    <div class="p-6 flex-grow">
                        ...
                        <p class="text-sm text-gray-500 mb-4 line-clamp-2"><?= htmlspecialchars($p->descripcion) ?></p>
